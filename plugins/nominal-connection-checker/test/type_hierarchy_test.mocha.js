...
suite('TypeHierarchy', function() {
  ...
  suite('getParamsForDescendant', function() {
    ...
    suite('Explicit param, properly fulfilled', function() {
      test('Covariant exact', function() {
        ...
        this.assertParams(hierarchy, 'typea', 'typeb', ['typec'], []);
      });

      test('Covariant sub', function() {
        const hierarchy = this.createTypeHierarchy({
          'typeA': {
            'params': [
              {
        ...
        this.assertParams(hierarchy, 'typea', 'typeb', ['typed'], []);
      });

      test('Contravariant exact', function() {
        const hierarchy = this.createTypeHierarchy({
          'typeA': {
            'params': [
              {
      ...
      test('Contravariant super', function() {
        const hierarchy = this.createTypeHierarchy({
          'typeA': {
            'params': [
              {
  ...
  suite('typeFulfillsType', function() {
    ...
    suite('Generics', function() {
      ...
      test('Super generic', function() {
        this.assertFulfills(this.hierarchy, 'typeA', 't');
      });

      test('Sub generic', function() {
        this.assertFulfills(this.hierarchy, 't', 'typeA');
      });

      test('Both generic', function() {
        this.assertFulfills(this.hierarchy, 't', 'g');
      });
    });
    ...
    suite('Generic params', function() {
      suite('Covariant', function() {
        ...
        test('Pure generic w/ generic params', function() {
          this.assertFulfills(this.hierarchy, 't', 'typeA[A]');
        });
        ...
        test('Both generic', function() {
          this.assertFulfills(this.hierarchy, 'typeA[A]', 'typeA[B]');
        });
      ...
      suite('Other', function() {
        // Ensuring that identical generics are generic types is not the job of
        // the type hierarchy, b/c you may not necessarily want that.
        // The getMatchingGenericsForX function should be used to ensure this
        // behavior, if desired.
        test('Dict[T, T], Dict[Cat, Dog] Compatible', function() {
          const hierarchy = this.createTypeHierarchy({
            'Dict': {
              'params': [
                {
          ...
          this.assertFulfills(hierarchy, 'Dict[Cat, Dog]', 'Dict[t, t]');
        });

        // See comment above previous test for why this is allowed.
        test('Dict[T, T], Dict[Cat, Chair] Compatible', function() {
          const hierarchy = this.createTypeHierarchy({
            'Dict': {
              'params': [
                {
          ...
          this.assertFulfills(hierarchy, 'Dict[Cat, Chair]', 'Dict[t, t]');
        });

        test('List[List[T]], List[T] Compatible', function() {
          const hierarchy = this.createTypeHierarchy({
            'List': {
              'params': [
                {
          ...
          this.assertFulfills(hierarchy, 'List[T]', 'List[List[T]]');
        });

        test('List[List[T]], List[Dog] Incompatible', function() {
          const hierarchy = this.createTypeHierarchy({
            'List': {
              'params': [
                {
          ...
          this.assertDoesNotFulfill(hierarchy, 'Dog', 'List[List[T]]');
        });
      });
    });
  });
  ...
  suite('nearestCommonParents', function() {
    ...
    suite('Simple unions, order', function() {
      setup(function() {
        this.hierarchy = this.createTypeHierarchy({
          'typeA': {},
          'typeB': {},
      ...
      test('A, C, D', function() {
        this.assertNearestCommonParents(
            this.hierarchy, ['typeA', 'typeC', 'typeD'], ['typeA']);
      });
      ...
      test('A, A, B', function() {
        this.assertNoNearestCommonParents(
            this.hierarchy, ['typeA', 'typeA', 'typeB']);
      });

      test('A, B, A', function() {
        this.assertNoNearestCommonParents(
            this.hierarchy, ['typeA', 'typeB', 'typeA']);
      });

      test('B, A, A', function() {
        this.assertNoNearestCommonParents(
            this.hierarchy, ['typeB', 'typeA', 'typeA']);
      });
    });
    ...
    setup(function() {
      this.assertNearestCommonDescendants =
          function(hierarchy, toUnify, expected) {
            ...
            actual.forEach((typeStruct, i) => {
              if (!typeStruct.equals((parseType(expected[i])))) {
                chai.assert.fail('Expected ' + structureToString(typeStruct) +
                    ' to equal ' + expected[i]);
              }
            });
          };
      ...
      suite('Unifying outer types', function() {
        ...
        suite('Explicit types', function() {
          ...
          suite('Non-explicit parents w/ explicit child', function() {
            suite('Covariant', function() {
              test('Explicits - Exact types', function() {
                const hierarchy = this.createTypeHierarchy({
                  'typeA': {
                    'params': [
                      {
              ...
              test('Explicits - Two parents', function() {
                const hierarchy = this.createTypeHierarchy({
                  'typeA': {
                    'params': [
                      {
                ...
                this.assertNearestCommonDescendants(
                    hierarchy, ['typeA[typeC]', 'typeB[typeD]'], ['typeF']);
              });

              test('Explicits - Two children', function() {
                const hierarchy = this.createTypeHierarchy({
                  'typeA': {
                    'params': [
                      {
                  ...
                  'typeF': {
                    'fulfills': ['typeA[typeD]', 'typeB[typeE]'],
                  },
                });
                this.assertNearestCommonDescendants(
                    hierarchy, ['typeA[typeC]', 'typeB[typeC]'], ['typeF']);
              });

              test('Nested explicits - Exact types', function() {
                const hierarchy = this.createTypeHierarchy({
                  'typeA': {
                    'params': [
                      {
                  ...
                  'typeF': {
                    'fulfills': ['typeA[typeA[typeC]]', 'typeB[typeB[typeD]]'],
                  },
                });
                this.assertNearestCommonDescendants(
                    hierarchy,
              ...
              test('Nested explicits - Two parents', function() {
                const hierarchy = this.createTypeHierarchy({
                  'typeA': {
                    'params': [
                      {
              ...
              test('Nested explicits - Two children', function() {
                const hierarchy = this.createTypeHierarchy({
                  'typeA': {
                    'params': [
                      {
                  ...
                  'typeF': {
                    'fulfills': ['typeA[typeA[typeD]]', 'typeB[typeB[typeE]]'],
                  },
                });
                this.assertNearestCommonDescendants(
                    hierarchy,
                    ['typeA[typeA[typeC]]', 'typeB[typeB[typeC]]'],
                    ['typeF']);
              });
            ...
            suite('Contravariant', function() {
              ...
              test('Nested explicits', function() {
                const hierarchy = this.createTypeHierarchy({
                  ...
                  'typeG': {
                    'fulfills': ['typeA[typeF[typeC]]', 'typeB[typeF[typeC]]'],
                  },
                });
                this.assertNearestCommonDescendants(
                    hierarchy,
  ...
  suite('getMatchingExplicitsInDescendant', function() {
    setup(function() {
      this.assertMatches =
          function(hierarchy, generic, source, target, expected) {
            const actual = hierarchy.getMatchingTypesInDescendant(
                parseType(generic), parseType(source), parseType(target));
            chai.assert.equal(actual.length, expected.length,
                'Expected the length of the matches array to ' +
                'match the length of the expected array.');
            actual.forEach((typeStruct, i) => {
              if (!typeStruct.equals((parseType(expected[i])))) {
                chai.assert.fail('Expected ' + structureToString(typeStruct) +
      ...
      this.assertNoMatch = function(hierarchy, generic, source, target) {
        const actual = hierarchy.getMatchingTypesInDescendant(
    ...
    test('No instance of generic in source', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {
          'params': [
            {
      ...
      this.assertNoMatch(
          hierarchy, 't', 'typeA[typeA[g]]', 'typeA[typeA[typeB]]');
    });

    test('Generic, Generic', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {},
      });
    ...
    test('Generic, Standard generic', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {},
      });
      this.assertMatches(hierarchy, 't', 't', '*', ['*']);
    });
    ...
    test('Generic param, generic', function() {
      ...
      this.assertNoMatch(hierarchy, 't', 'typeA[t]', 'g');
    });

    test('Generic param, Explicit param - same outers', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {
          'params': [
            {
    ...
    suite('Multiple params', function() {
      ...
      test('Multiple params, Single param', function() {
        const hierarchy = this.createTypeHierarchy({
          ...
          'typeB': {
            // Ends up being typeC b/c of this.
            'fulfills': ['typeA[typeC, A]'],
            'params': [
              {
                'name': 'A',
      ...
      test('Multiple same param, Multiple same param', function() {
        const hierarchy = this.createTypeHierarchy({
          'typeA': {
            'params': [
              {
      ...
      test('Multiple same param, Multiple diff params', function() {
        const hierarchy = this.createTypeHierarchy({
          'typeA': {
            'params': [
              {
      ...
      test('Multiple same param - nested, Multiple diff params', function() {
        const hierarchy = this.createTypeHierarchy({
          'typeA': {
            'params': [
              {
        ...
        this.assertMatches(
            ...
            't',
            'typeA[t, typeC[t]]',
            'typeB[typeD, typeC[typeE]]',
            ['typeD', 'typeE']);
      });
    });

    test('Nested generic param, Generic', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {
          'params': [
            {
      ...
      this.assertNoMatch(hierarchy, 't', 'typeA[typeA[t]]', 'g');
    });

    test('Nested generic param, Generic param', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {
          'params': [
            {
      ...
      this.assertNoMatch(hierarchy, 't', 'typeA[typeA[t]]', 'typeA[g]');
    });

    test('Nested generic param, Nested generic param', function() {
      const hierarchy = this.createTypeHierarchy({
        'typeA': {
          'params': [
            {
  ...
  suite('getMatchingExplicitsInAncestor', function() {
    setup(function() {
      this.assertMatches =
          function(hierarchy, generic, source, target, expected) {
            const actual = hierarchy.getMatchingTypesInAncestor(
                parseType(generic), parseType(source), parseType(target));
            chai.assert.equal(actual.length, expected.length,
                'Expected the length of the matches array to ' +
                'match the length of the expected array.');
